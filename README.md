...
### T01 涂山氏篇 v1 收稿
[摘要、審閱與 Claude 修訂指示](docs/story-drafts/tushan-t01-v1/README.md)：檢查少數住客自主、真實法則證據邊界及跨時代主線可達性。新內容仍為提案，F01 v1.2 引用待定位，未實作玩法。


### P01 玉皇 Prime 篇 v1 收稿
[摘要、審閱與 Claude 修訂指示](docs/story-drafts/prime-p01-v1/README.md)：核對登錄授權、命錨門檻、封存證據與跨時代政策後果。新增內容仍為提案，未實作玩法。
...
保存 [W01 v1.2 原稿、收斂審閱與完整交接檔](docs/story-drafts/warren-w01-v1.2/README.md)，保留先前版本。本版已解主要跨世契約與證據問題；剩餘八組精修包含 K5 門檻、無後人店產處理、通知與實際停止追索、跨世資格待查驗。單一 CLAUDE_HANDOFF 含完整原稿及前後兩次審閱，避免附件未傳齊；未新增正史或 Godot 實作。


## A01 亞茲篇 v1.1 收稿

保存 [A01 v1.1 原稿與完整交接檔](docs/story-drafts/az-a01-v1.1/README.md)，v1 保留。已改善收容、陪伴與有限照魂；本次七組精修著重紀錄錯配不等於靈魂滯留、親授須實際完成陪伴、既有政策不可因缺席重置，以及跨世辨認與離場接口。交接檔含完整原稿與前後兩次審閱，新增提案不升格，未接 Godot。


## L01 陸吾篇 v1 收稿

保存 [L01《帝之下都》原稿、審閱與完整交接檔](docs/story-drafts/luwu-l01-v1/README.md)。核對永恆聖堂地點與創世能力，檢查 K6／K7 對質入口、證據與知情來源、三方結盟、法則資格及世界惡化。新增十項依賴審閱，附主線接口摘錄；收稿不代表八篇均已驗收或新增提案定案，未接 Godot。
