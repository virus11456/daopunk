...
[世界觀基準與來源](SOURCES.md) · [卡牌與道具](../cards-items/README.md) · [五術職業與修行樹](../cards-items/FIVE_ARTS.md) · [離線圖鑑](gallery.html)

本次包含 10 張宇宙代表場景（沿用已選定的歸墟圖，另生成 9 張），20 個星球環境位置、40 個城市／聚落／街區視覺模板。模板不是完整正式地名名單；沒有來源依據的地名不自行宣布為正史。每張主視覺代表其中一個街區，其餘地點目前是文字規範，並非各自已生成畫面。
